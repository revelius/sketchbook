...
(function($){
	...
	var agreement01 = (function(){
		...
		function init(){
			...
			if(el.children().length <= 0){
				window.agreement01 = $.get('/html/worksout/inc/layout/agreement01.html');
	...
	var agreement02 = (function(){
		...
		function init(){
			...
			if(el.children().length <= 0){
				window.agreement02 = $.get('/html/worksout/inc/layout/agreement02.html');
	...
	var agreement03 = (function(){
		...
		function init(){
			...
			if(el.children().length <= 0){
				window.agreement03 = $.get('/html/worksout/inc/layout/agreement03.html');
	...
	var agreement04 = (function(){
		...
		function init(){
			...
			if(el.children().length <= 0){
				window.agreement04 = $.get('/html/worksout/inc/layout/agreement04.html');
	...
	var header = (function(){
		...
		function init(){
			...
			if(el.children().length <= 0){
				window.header = $.get('/html/worksout/inc/layout/header.html');
	...
	var footer = (function(){
		...
		function init(){
			...
			if(el.children().length <= 0){
				window.footer = $.get('/html/worksout/inc/layout/footer.html');
	...
	var snbMain = (function(){
		...
		function init(){
			...
			if(el.children().length <= 0){
				window.snbMain = $.get('/html/worksout/inc/layout/snb_main.html');
	...
	var snbShop = (function(){
		...
		function init(){
			...
			if(el.children().length <= 0){
				window.snbShop = $.get('/html/worksout/inc/layout/snb_shop.html');
	...
	var snbNews = (function(){
		...
		function init(){
			...
			if(el.children().length <= 0){
				window.snbNews = $.get('/html/worksout/inc/layout/snb_news.html');
	...
	var snbStoreInfo = (function(){
		...
		function init(){
			...
			if(el.children().length <= 0){
				window.snbStoreInfo = $.get('/html/worksout/inc/layout/snb_store_info.html');
	...
	var snbLookBook = (function(){
		...
		function init(){
			...
			if(el.children().length <= 0){
				window.snbLookBook = $.get('/html/worksout/inc/layout/snb_lookbook.html');
	...
	var snbJoin = (function(){
		...
		function init(){
			...
			if(el.children().length <= 0){
				window.snbJoin = $.get('/html/worksout/inc/layout/snb_join.html');
	...
	var snbMypage = (function(){
		...
		function init(){
			...
			if(el.children().length <= 0){
				window.snbMypage = $.get('/html/worksout/inc/layout/snb_mypage.html');
	...
	var snbCart = (function(){
		...
		function init(){
			...
			if(el.children().length <= 0){
				window.snbCart = $.get('/html/worksout/inc/layout/snb_cart.html');
	...
	var snbOrder = (function(){
		...
		function init(){
			...
			if(el.children().length <= 0){
				window.snbOrder = $.get('/html/worksout/inc/layout/snb_order.html');
	...
	var snbContactUs = (function(){
		...
		function init(){
			...
			if(el.children().length <= 0){
				window.snbContactUs = $.get('/html/worksout/inc/layout/snb_contact_us.html');
	...
	var snbWorkWithUs = (function(){
		...
		function init(){
			...
			if(el.children().length <= 0){
				window.snbWorkWithUs = $.get('/html/worksout/inc/layout/snb_work_with_us.html');
	...
	var snbSearch = (function(){
		...
		function init(){
			...
			if(el.children().length <= 0){
				window.snbSearch = $.get('/html/worksout/inc/layout/snb_search.html');
...
// console.log(currentId - 1);
	...
	var layerPopupUI = (function(){
		...
		function loadPopup(template){
			$.get('/html/worksout/inc/layout/layer_common.html').done(function(data){
