...
(function($){
    ...
    var header = (function(){
        ...
        function init(){
            ...
            if(el.children().length <= 0){
                window.header = $.get('/front/header');
    ...
    var snbShop = (function(){
        ...
        function init(){
            ...
            if(el.children().length <= 0){
                window.snbShop = $.get('/front/snbShop?oneDepth='+$('#oneDepth').val()+"&twoDepth="+$('#twoDepth').val()+"&threeDepth="+$('#threeDepth').val()+"&sex="+$('#sex').val()+"&ubiGdsSize="+$('#ubiGdsSize').val()+"&orderBy="+$('#orderBy').val()+"&orderFlag="+$('#orderFlag').val()+"&brand="+$('#brand').val());
...
//          });
    ...
    $(function(){
        ...
        // overImg.init();  // grayscale 처리 안함, 160125
        fullScroll.init();
