...
! function(a) {
    ...
    a.extend(a.FroalaEditor.POPUP_TEMPLATES, {
        ...
        function e() {
            ...
            var d = ka.offset().left + ka.outerWidth() / 2,
                e = ka.offset().top + ka.outerHeight();
        ...
        function g(b) {
            ...
            b.hasClass("fr-dib") ? (a.extend(c, {
                "vertical-align": "top",
                display: "block"
            }), b.hasClass("fr-fir") ? a.extend(c, {
                "float": "none",
                "margin-right": "0",
                "margin-left": "auto"
            }) : b.hasClass("fr-fil") ? a.extend(c, {
                "float": "none",
                "margin-left": "0",
                "margin-right": "auto"
            }) : a.extend(c, {
                ...
                "float": "none"
            })), b.removeClass("fr-dib fr-dii fr-fir fr-fil fr-fin"), "" === b.attr("class") && b.removeAttr("class"), b.css(c)
        }
        ...
        function i() {
            for (var c = "IMG" == b.$el.get(0).tagName ? [b.$el.get(0)] : b.$el.get(0).querySelectorAll("img"), d = 0; d < c.length; d++) h(a(c[d])), b.opts.iframe && a(c[d]).on("load", b.size.syncIframe)
        }

        function j() {
            var c = Array.prototype.slice.call(b.$el.get(0).querySelectorAll("img"));
            if (wa)
                for (var d = 0; d < wa.length; d++) c.indexOf(wa[d]) < 0 && b.events.trigger("image.removed", [a(wa[d])]);
            wa = c
        }
        ...
        function p(a, c) {
            b.edit.on(), u(b.language.translate("Something went wrong. Please try again.")), b.events.trigger("image.error", [{
                code: a,
                message: va[a]
            }, c])
        }
        ...
        function C(a) {
            ...
            if ("undefined" != typeof a && a.length > 0) {
                var c = a[0];
                if (c.size > b.opts.imageMaxSize) return p(sa), !1;
                if (b.opts.imageAllowedTypes.indexOf(c.type.replace(/image\//g, "")) < 0) return p(ta), !1;
                var d;
        ...
        function F() {
            ...
            var h = '<div class="fr-image-progress-bar-layer fr-layer"><h3 class="fr-message">Uploading</h3><div class="fr-loader"><span class="fr-progress"></span></div><div class="fr-action-buttons"><button type="button" class="fr-command fr-back" data-cmd="imageDismissError" tabIndex="2">OK</button></div></div>',
                i = {
                    buttons: d,
                    upload_layer: e,
                    by_url_layer: g,
                ...
                j = b.popups.create("image.insert", i);
        ...
        function H() {
            ...
            var d = ka.offset().left + ka.width() / 2,
                e = ka.offset().top + ka.height();
        ...
        function O(a) {
            ...
            if (ka || b.opts.toolbarInline) ka && (d = ka.offset().top + ka.outerHeight());
            else {
        ...
        return {
            ...
            align: ba,
            refreshAlign: ca,
            refreshAlignOnShow: da,
            display: ea,
            refreshDisplayOnShow: fa,
            replace: ga,
            back: ha,
            get: ia,
            insert: w,
        ...
        html: function() {
            ...
            for (var d in c) b += '<li><a class="fr-command" data-cmd="imageAlign" data-param1="' + d + '" title="' + this.language.translate(c[d]) + '"><i class="fa fa-align-' + d + '"></i></a></li>';
            return b += "</ul>"
        },
        callback: function(a, b) {
            this.image.align(b)
        ...
        html: function() {
            ...
            for (var c in b) a += '<li><a class="fr-command" data-cmd="imageStyle" data-param1="' + c + '">' + b[c] + "</a></li>";
            return a += "</ul>"
        },
        callback: function(a, b) {
