...
(function ($) {
  ...
  $.extend($.FroalaEditor.DEFAULTS, {
    ...
    imageUploadURL: '/common/fileUploadEditor',
  ...
  $.FroalaEditor.PLUGINS.image = function (editor) {
    ...
    function _initInsertPopup () {
      ...
      if (editor.opts.imageInsertButtons.indexOf('imageUpload') >= 0) {
        ...
        upload_layer = '<div class="fr-image-upload-layer' + active + ' fr-layer" id="fr-image-upload-layer-' + editor.id + '"><strong>' + editor.language.translate('Drop image') + '</strong><br>(' + editor.language.translate('or click') + ')<form><input type="file" name="' + editor.opts.imageUploadParam + '" accept="image/*" tabIndex="-1" multiple></form></div>'
      }
