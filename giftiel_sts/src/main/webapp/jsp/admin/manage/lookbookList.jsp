...
<head>
	...
	$(function() { 
	    ...
	    goDetail = function(e){
	    	...
	    	frm.action = "<c:url value='/admin/manage/lookbookDetail'/>";
	    	frm.submit();
	    };
	    ...
	    $('#btn_reg').click(function() {
	    	...
	    	frm.hiddenSearchGb.value = $("#searchGb").val();
	    	frm.hiddenSearchText.value = $("#searchText").val();
	    	frm.action = "<c:url value='/admin/manage/regLookbook'/>";
	    	frm.submit();
	    });
...
<!-- 					<div class="helpBox"> -->
<!-- 						<ul class="boxLi"> -->
<!-- 							<li>- 브랜드 별 LOOKBOOK 목록 입니다.</li> -->
<!-- 							<li>- 브랜드 별 상세 목록 조회가 가능합니다.</li> -->
<!-- 							<li>- 등록된 LOOKBOOK은 WORKSOUT에서 전체 노출되며 브랜드 사이트에서는 해당 브랜드에 등록된 게시물만 노출됩니다.</li> -->
<!-- 						</ul> -->
										...
										<table>
											...
											<thead>
												<tr id="sortTr">
													...
													<th scope="row">제목</th>
													<th scope="row">작성자</th>
													<th scope="row">작성일<a id="ORI_UPD_DTS" href="#" onclick="javascript:setOrderBy(this);" class="down">▼</a></th>
												</tr>
											</thead>
											<tbody>	
												<c:choose>
													<c:when test="${not empty lookbookList}">
														<c:forEach items="${lookbookList}" var="lookbook" varStatus="listCount">
															<tr>
																<td>${lookbook.rnum}</td>	
																<td>${lookbook.dispYn}</td>
																<td class="tl"><a href="#" onclick="javascript:goDetail(this);" data-txtNo="<c:out value='${lookbook.txtNo}'/>">${lookbook.title}</a></td>
																<td>${lookbook.regUserNm}</td>
																<td>${lookbook.updDts}</td>
															</tr>
														</c:forEach>
													</c:when>
													<c:otherwise>
