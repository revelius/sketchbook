...
<head>
    ...
    $(function() { 
	    ...
	    $('#btn_search').click(function() {
	        ...
	        frm.target = '_self';
	        frm.action = 'popupGoodsListForStatistics';
	        frm.submit();
	    });
		...
		//체크데이터 객체로 부모창으로 전달
	    parantSendCallBack = function(val) {
	    	var goodsData = val;
		...
		<div id="container">
			<div class="subWrap">
				...
				<div class="contents productList" style="margin-left:0px; width:700px;">
					...
					<form:hidden path="resultId" id="resultId" value="${param.resultId}"/>				
					<!--[s] 상품목록 -->
							...
							<tbody>
								<c:forEach items="${goodsList}" var="goods" varStatus="listCount">
									<tr>
										...
										<td>
											<a href="javascript:parantSendCallBack('${goods.ubiGoods.ubiGdsNo }:${goods.ubiGoods.ubiGdsNm }:${goods.ubiGoods.ubiSlPrc }${goods.ubiGoods.stock }');" id="btn_addData" class="btnType2" data-value="${goods.ubiGoods.ubiGdsNo }:${goods.ubiGoods.ubiGdsNm }:${goods.ubiGoods.ubiSlPrc }${goods.ubiGoods.stock }">선택완료</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
