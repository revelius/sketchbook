...
<head>
	...
	$(function() { 
	    ...
	    $('#btn_save').click(function() {
	        ...
	        frm.target = '_self';
	        frm.action = 'saveGoodsDisplayNew';
	        frm.submit();
	    });		
			...
			<div class="subWrap">
				...
				<div class="contents productList">
					...
					<div class="section a1">
						<h3><span class="icon1"></span>상품진열설정[NEW]</h3>
								...
								<tbody>	
									<tr>
										...
										<td>
											...
											<form:select path="brandCode">
												<form:option value="">브랜드</form:option>
												<form:options items="${brandCode}" itemLabel="cdDesc" itemValue="cdNm"/>
											</form:select>
										</td>
									</tr>	
									<tr>
...
<!-- 					</div>										 -->
					...
					<input type="hidden" id="newArvl" name="newArvl" value="${param.newArrival}">
					<input type="hidden" id="siteNo" name="siteNo" value="${param.brand }">
					<input type="hidden" id="brand" name="brand" value="${param.brandCode }">
					<input type="hidden" id="oneDepth" name="oneDepth" value="${param.oneDepth }">
					<input type="hidden" id="twoDepth" name="twoDepth" value="${param.twoDepth }">
					<input type="hidden" id="threeDepth" name="threeDepth" value="${param.threeDepth }">
					<input type="hidden" id="sex" name="sex" value="${param.sex }">
