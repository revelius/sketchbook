<%--
 * =============================================================================
 * 파일명 : /statistics/visitantMonthStatistics.jsp
 * 작성자 : 이현우
 * 작성일자 : 2015-07-10
 *
 * 파일 내용 : 통계 메인
	...
	<script type="text/javascript">
	    $(function() {
		    ...
		    goSubmit = function(){
				...
				var searchDate = $("#sYear").val() + "." + sTwoMonth.substring(sTwoMonth.length-2,3) + ".01";
				
				$("#searchStrDtm").val(searchDate);
		    ...
		    $('#monthStatisticsTable').rowspan(0);
...
<!-- 				<a href="#" class="btnType2 advice">도움말</a> -->
				...
				<div class="section a2">
					<div class="tableTitle">
						...
						<div class="right">
							<a href="#" class="btnType2">전달보기</a>
							<a href="#" class="btnType2">오늘보기</a>
							<a href="#" class="btnType2">다음달보기</a>
						</div>
					</div>
					<div class="tableType1">
						<table id="monthStatisticsTable">
