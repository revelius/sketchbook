<%--
 * =============================================================================
 * 파일명 :  /front/myPage/nMemOrderChangeList.jsp
 * 작성자 : 김진성
 * 작성일자 : 2015-07-08
 *
 * 파일 내용 : 비회원 교환 내역 리스트
    		...
    		$(function() { 
    		    ...
    		    goSubmit = function(){
   			        var frm = document.searchForm;
   						frm.action = "<c:url value='/front/myPage/nMemOrderChangeList'/>";
			 	        frm.submit();
    		    };
    		    ...
    		    $(document).on("click","a[data-ordGdsSeq]",function(e){
    		    	...
    		    	var frm = document.hiddenForm;
   		    		...
   		    		frm.action = "<c:url value='/front/myPage/nMemOrderChangeDetail'/>";
	 	        	frm.submit();
    		  ...
    		  //date 형변환 함수/////////////////////////////////////////////////////////////////////
    			...
    			loadMore = function() {
    				...
    				$.ajax({
    			        url : "<c:url value='/front/myPage/nMemOrderChangeAjax'/>",
    			        type: "post",
							...
							<div class="content_area">
								<div class="mypage_area">
									...
									<form:form id="searchForm" name="searchForm" method="post" modelAttribute="searchForm" onsubmit="">
										...
										<form:hidden path="ordKnd" value="cancle"/>
