<%--
 * =============================================================================
 * 파일명 :  /front/myPage/nMemOrderChangeDetail.jsp
 * 작성자 : 김진성
 * 작성일자 : 2015-08-07
 *
 * 파일 내용 : 비회원 교환내역 상세
	...
	<head>
		...
		<script type="text/javascript">
    		$(function() { 
    			...
    			//교환취소
    			$("#changeCancel").on("click",function(e){
    				e.preventDefault();
    				
    				if(!confirm("교환신청을 취소하시겠습니까?")) return false;
    				
    				$.ajax({
    	   		        url : "<c:url value='/front/myPage/nMemClaimCancelAjax'/>",
    	   		        type: "post",
    	   		        data : $("form#hiddenForm").serialize(),
    	   		    	async: true,
    	   		        success : function(res){
    	   		            if (res > 0) {
    	   		            	alert("교환 신청이 취소 되었습니다.");
    	   		            	location.href="<c:url value='/front/myPage/nMemOrderChangeList'/>";
    	   					} else {
						...
						<div class="content_section">
							<div class="content_area">
								<div class="mypage_area">
									...
									<!-- 
									<div class="mypage_tit clfix space01">
										<span class="txt01">교환내용</span>
									</div>
									<div class="box_gray01 clfix">
										<div class="box01 clfix">
											<ul class="mypage_info04">
												<li class="etc_style01">
													<div class="tit02">Obey Surveillance Eye 상품은 M으로, Envoy Jacket은 L로 바꿔주세요.</div>
												</li>
											</ul>
										</div>
									</div>
...
<%-- 									</c:choose> --%>
									...
									<!-- 배송비 관련 협의중 -->
									<!-- 
									<table class="tbl_col02 space01 tbl_col02_mypage_order_list03 ui_reponsible_table_type01">
										<caption>취소/반품 내역 테이블로 총 결제금액, 총 환불금액, 사용 포인트 반환에 관하여 확인할 수 있습니다.</caption>
										<thead>
											<tr>
												<th scope="col">총 결제금액</th>
												<th scope="col">상품 동봉배송비</th>
										...
										<tbody>
											<tr>
												...
												<td class="tbl_layout05">
													<div class="mobile_th">총 결제금액</div>
													<div class="tbl_cont">
														<span class="ico_price"><fmt:formatNumber type="currency" value="${order.totalPayAmt}" pattern="###,###" /></span>
													</div>
												</td>
											</tr>
										</tbody>
									...
									<div class="mypage_tit clfix space01">
										<span class="txt01">교환 배송지 정보</span>
									</div>
									<div class="box_gray01 clfix">
										<div class="clfix">
											<ul class="mypage_info04 floating">
												<li>
													...
													<div class="desc">${order.rcpnNm}</div>
												</li>
												<li>
													<div class="tit">전화번호</div>
													<div class="desc">${order.rcpnTelNo}</div>
												</li>
												<li>
													<div class="tit">휴대폰번호</div>
													<div class="desc">${order.rcpnCpNo}</div>
												</li>
												<li class="last_child">
													<div class="tit">주소</div>
													<div class="desc">${order.rcpnBsAddr} ${order.rcpnDtlAddr}</div>
												</li>
											</ul>
											<ul class="mypage_info04 floating">
												<li class="last_child">
													...
													<div class="desc">${orderclm.dlvSvcMemo}
													</div>
												</li>
											</ul>
										</div>
									...
									<div class="btn_area04 clfix">
										<div class="btn01" <c:if test="${orderclm.clmStat ne 'OR01701'}">style="display: none;"</c:if>>
											<a href="#" data-template="ui_popup_cancel_confirm" data-callback="callback_test01"	class="btn_black01 ui_btn_popup" id="changeCancel">교환취소</a>
										</div>
										<div class="btn02">
											<a href="<c:url value="/front/myPage/nMemOrderChangeList"/>" class="btn_gray01">목록보기</a>
										</div>
									</div>
									<!-- 상황에 맞게 아래 btn01, btn02 영역을 삭제 할 수 있습니다. -->
								</div>
