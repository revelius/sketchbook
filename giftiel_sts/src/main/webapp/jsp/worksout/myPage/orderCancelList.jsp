<%--
 * =============================================================================
 * 파일명 :  /front/myPage/orderCancelList.jsp
 * 작성자 : 김진성
 * 작성일자 : 2015-07-08
 *
 * 파일 내용 : 취소 반품 내역 리스트
    		...
    		$(function() { 
    		    ...
    		    goSubmit = function(){
   			        var frm = document.searchForm;
   						frm.action = "<c:url value='/front/myPage/orderCancelList'/>";
			 	        frm.submit();
    		    };
    		    ...
    		    $(document).on("click","a[data-ordGdsSeq]",function(e){
					...
					frm.action = "<c:url value='/front/myPage/orderCancelDetail'/>";
	 	        	frm.submit();
    			...
    			loadMore = function() {
    				...
    				$.ajax({
    			        url : "<c:url value='/front/myPage/orderCancelListAjax'/>",
    			        type: "post",
    			        	...
    			        	try{
    			        		...
    			        		if (data.length > 0) {
    			        			...
    			        			for(var i=0;i<data.length;i++) {
    			        				...
    			        				var clmRegDts = new Date(data[i].clmRegDts).format("yyyy-MM-dd");
    			        				...
    			        				var html = 
    										...
    										"		<div class=\"tbl_cont\">" +
    										"			<div class=\"p_tit\"><a href=\"#\" class=\"btn_order\" data-orderNo=\"" + data[i].ordNo + "\" data-ordGdsSeq=\"" + data[i].ordGdsSeq + "\">[" + data[i].brand +"] " + data[i].ubiGdsNm +"</a></div>" +
    										...
    										"		<div class=\"tbl_cont\">"+clmRegDts+"<p></div>" +
    										"	</td>" +
							...
							<div class="content_area">
								<div class="mypage_area">
									...
									<form:form id="searchForm" name="searchForm" method="post" modelAttribute="searchForm" onsubmit="">
			        					...
			        					<form:hidden path="ordKnd" value="cancleAndTakeBack"/>
									...
									<p class="mypage_txt_style02">- 주문번호를 누르시면 취소/반품 결과에 대한 상세내역을 보실 수 있습니다.</p>
													...
													<c:forEach var="order" items="${orderList}" varStatus="orderIndex">
														<tr>
															...
															<td class="tbl_layout04">
																<div class="mobile_th">상품</div>
																<div class="tbl_cont">
																	<div class="p_tit"><a href="#" class="btn_order" data-orderNo="${order.ordNo}" data-ordGdsSeq="${order.ordGdsSeq}">[${order.brand}] ${order.ubiGdsNm}</a></div>
															...
															<td class="tbl_layout06">
																<div class="mobile_th">총 환불금액</div>
																<div class="tbl_cont">
																	<span class="ico_price">${order.actlPayPrc}</span>
																</div>
															</td>
															<td class="tbl_layout07">
																<div class="mobile_th">상태</div>
