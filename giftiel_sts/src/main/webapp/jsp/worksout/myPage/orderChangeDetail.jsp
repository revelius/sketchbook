<%--
 * =============================================================================
 * 파일명 :  /front/myPage/orderChangeDetail.jsp
 * 작성자 : 김진성
 * 작성일자 : 2015-07-15
 *
 * 파일 내용 : 교환내역 상세
    				...
    				$.ajax({
    	   		        ...
    	   		        success : function(res){
    	   		            if (res > 0) {
    	   		            	...
    	   		            	location.href="<c:url value='/front/myPage/orderChangeList'/>";
    	   					} else {
...
<!-- 												</li> -->
									...
									<div class="btn_area04 clfix">
										...
										<div class="btn02">
											<a href="<c:url value="/front/myPage/orderChangeList"/>" class="btn_gray01">목록보기</a>
										</div>
									</div>
									<!-- 상황에 맞게 아래 btn01, btn02 영역을 삭제 할 수 있습니다. -->
								</div>
