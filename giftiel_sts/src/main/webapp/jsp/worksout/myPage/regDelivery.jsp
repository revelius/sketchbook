<%--
 * =============================================================================
 * 파일명 :  /front/myPage/regDelivery.jsp
 * 작성자 : 김진성
 * 작성일자 : 2015-07-01
 *
 * 파일 내용 : 배송지 추가,수정
...
// 				});
				...
				$("#addDlv").on("click",function(e){
    				...
    				$.ajax({
       	   		        url : "<c:url value='/front/myPage/addMydlvAddrAjax'/>",
       	   		        type: "post",
...
<%-- 											<input type="hidden" id="addrBynm" name="addrBynm" value="${mydlvAddr.addrBynm}"/> --%>
											<input type="hidden" id="baseValYn" name="baseValYn" value="${mydlvAddr.baseValYn}"/>
										<table class="tbl_row02">
											...
											<tbody>
												<tr>
													...
													<td data-area="myDlv">
														<div class="input_txt">
															<input type="text" name="addrBynm" id="addrBynm" value="${mydlvAddr.addrBynm }" placeHolder="주소별칭"/>
														</div>
													</td>
												</tr>
												<tr>
													...
													<td class="txt_align01" data-dlvy="nm">
														<div class="input_txt">
															<input type="text" id="nm" name="nm" value="" placeHolder="수령인 이름">
														</div>
													</td>
												</tr>
												<tr>
...
<!-- 																	<a href="#" data-template="ui_popup_post_search" data-callback="callback_test01" class="btn_white01 ui_btn_popup" id="openZipCd">우편번호검색</a> -->
										...
										<div class="btn_area01 clfix space01">
											<div class="btn01">
												<a href="#" class="btn_black01" id="addDlv">등록</a>
											</div>
<!-- 											<div class="btn02"> -->
