<%--
 * =============================================================================
 * 파일명 :  /front/myPage/nMemOrderCancelDetail.jsp
 * 작성자 : 김진성
 * 작성일자 : 2015-08-07
 *
 * 파일 내용 : 비회원 취소/반품 상세
    				...
    				$.ajax({
    	   		        ...
    	   		        success : function(res){
    	   		            if (res > 0) {
    	   		            	...
    	   		            	location.href="<c:url value='/front/myPage/nMemOrderCancelList'/>";
    	   					} else {
...
<!-- 									</table> -->
									...
									<div class="btn_area04 clfix">
										...
										<div class="btn02">
											<a href="<c:url value="/front/myPage/nMemOrderCancelList"/>" class="btn_gray01">목록보기</a>
										</div>
									</div>
