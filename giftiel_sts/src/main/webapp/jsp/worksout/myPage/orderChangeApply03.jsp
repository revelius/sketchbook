<%--
 * =============================================================================
 * 파일명 :  /front/myPage/orderChangeApply03.jsp
 * 작성자 : 김진성
 * 작성일자 : 2015-07-28
 *
 * 파일 내용 : 03. 신청완료
						...
						<div class="content_section">
							<div class="content_area">
								...
								<div class="mypage_area">
									<div class="mypage_top_tit">교환신청완료</div>
									<div class="mypage_content_layout01">
										<ul class="withdraw_notice_list">
											<li class="tit02">교환 신청이 완료되었습니다.</li>
											<li class="desc02">Mypage &gt; Order list &gt; 교환내역에서 확인바랍니다.</li>
											<li class="btn01">
												<a href="<c:url value="/front/myPage/${nextPage}"/>" class="btn_black01">교환내역 바로가기</a>
											</li>
										</ul>
									</div>
								</div>
