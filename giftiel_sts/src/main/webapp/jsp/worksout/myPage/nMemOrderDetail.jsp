<%--
 * =============================================================================
 * 파일명 :  /front/myPage/nMemOrderDetail.jsp
 * 작성자 : 김진성
 * 작성일자 : 2015-07-14
 *
 * 파일 내용 : 비회원 주문상세
    		...
    		$(function() { 
    			...
    			//우체국 배송조회
	   			...
	   			$("a[data-btn='btn_return']").on("click",function(e) {
	   				...
	   				form.action = "<c:url value='/front/myPage/nMemOrderReturnApply01'/>";
	   				form.submit();
    		    });
    		...
    		function updateOrderProcess(ordNo, ordGdsSeq, modType, perOrdStat, payWay){
    		   ...
    		   fm.submit();
				...
				<c:if test="${order.orderPay[0].payWay == 'OR00802' || order.orderPay[0].payWay == 'OR00803'}"><!-- 가상계좌 -->
					setTimeout("vctlCancelData();",3000);
				</c:if>
    		}  
												...
												<td class="tbl_layout04">
													...
													<div class="tbl_cont">
														...
														<span class="btn_state">
															...
															<a href="#" class="btn_underline01" data-btn="btn_delivery" data-invNo="${good.invNo}">배송추적</a>
...
<%--  												<li>
													<div class="tit">계좌번호</div>
 													<div class="desc">${order.orderPay[0].orderPayRtm[0].bankName} ${order.orderPay[0].orderPayRtm[0].account}</div>
 												</li> --%>
												<li>
