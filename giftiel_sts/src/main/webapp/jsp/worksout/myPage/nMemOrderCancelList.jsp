<%--
 * =============================================================================
 * 파일명 :  /front/myPage/nMemOrderCancelList.jsp
 * 작성자 : 김진성
 * 작성일자 : 2015-07-08
 *
 * 파일 내용 : 비회원 취소 반품 내역 리스트
 * =============================================================================
--%>
    		...
    		$(function() { 
    		    ...
    		    goSubmit = function(){
   			        var frm = document.searchForm;
   						frm.action = "<c:url value='/front/myPage/nMemOrderCancelList'/>";
			 	        frm.submit();
    		    };
    		    ...
    		    $(document).on("click","a[data-ordGdsSeq]",function(e){
					...
					frm.action = "<c:url value='/front/myPage/nMemOrderCancelDetail'/>";
	 	        	frm.submit();
    			...
    			loadMore = function() {
    				...
    				$.ajax({
    			        url : "<c:url value='/front/myPage/nMemOrderCancelListAjax'/>",
    			        type: "post",
