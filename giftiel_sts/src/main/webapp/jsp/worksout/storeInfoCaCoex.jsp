<%--
 * =============================================================================
 * 파일명 : /storeInfoCaCoex.jsp(WORKSOUT 서울코엑스)
 * 작성자 : 이현우
 * 작성일자 : 2016-08-10
 *
 * 파일 내용 : storeInfo
										...
										<div id="mySwipe" class="store_info_slide_container ui_swipe">
											...
											<!-- [Start] 스토어 이미지 슬라이드 등록부분 -->
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_COEXMALL_01.jpg" alt="서울 코엑스몰">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_COEXMALL_02.jpg" alt="서울 코엑스몰">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_COEXMALL_03.jpg" alt="서울 코엑스몰">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_COEXMALL_04.jpg" alt="서울 코엑스몰">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_COEXMALL_05.jpg" alt="서울 코엑스몰">
												</div>
...
<!-- 										</div> -->
									...
									<div class="store_info_map_wrap">
										<!-- NHN 맵 영역 -->
										<div id="naverMap" title="서울 코엑스몰" >
										<input type="hidden" id="lat" value="37.5121523" />
										<input type="hidden" id="lng" value="127.0585277" />
										</div>
									</div>

									<dl class="store_info_txt">
										<dt>CARHARTT WIP STORE SEOUL COEX MALL</dt>
										<dd>서울특별시 강남구 영동대로 513 코엑스몰 F101</dd>
										<dd>02.551.5512</dd>
