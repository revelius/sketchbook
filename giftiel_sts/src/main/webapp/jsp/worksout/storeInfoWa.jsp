<%--
 * =============================================================================
 * 파일명 : /storeInfoWa.jsp(WORKSOUT 와우산)
 * 작성자 : 이현우
 * 작성일자 : 2015-08-17
 *
 * 파일 내용 : storeInfo
							...
							<div class="content_area">
								<div class="store_info_aera">
										...
										<div id="mySwipe" class="store_info_slide_container ui_swipe">
											...
											<!-- [Start] 스토어 이미지 슬라이드 등록부분 -->
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/W_WORKSOUT_HONGDAE_00.jpg" alt="서울 홍대 와우산">
												</div>											
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/WORKSOUT_WOWSAN_F3_01.jpg" alt="서울 홍대 와우산">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/WORKSOUT_WOWSAN_F3_02.jpg" alt="서울 홍대 와우산">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/WORKSOUT_WOWSAN_F3_03.jpg" alt="서울 홍대 와우산">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/WORKSOUT_WOWSAN_F4_01.jpg" alt="서울 홍대 와우산">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/WORKSOUT_WOWSAN_F4_02.jpg" alt="서울 홍대 와우산">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/WORKSOUT_WOWSAN_F4_03.jpg" alt="서울 홍대 와우산">
												</div>
									...
									<div class="store_info_map_wrap">
										<!-- NHN 맵 영역 -->
										<div id="naverMap" title="서울 와우산점" >
										<input type="hidden" id="lat" value="37.5490462" />
										<input type="hidden" id="lng" value="126.9232120" />
										</div>
									</div>

									<dl class="store_info_txt">
										<dt>WORKSOUT STORE SEOUL HONGDAE WOWSAN</dt>
										<dd>서울특별시 마포구 와우산로 52</dd>
										<dd>02.337.8334</dd>
