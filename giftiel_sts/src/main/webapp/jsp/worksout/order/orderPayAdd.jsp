...
/*         function init_pay_button()
        ...
        function create_goodInfo()
        {
            ...
            var good_info = ""
        	<c:forEach items="${order.orderAddPay}" varStatus="listCount" var="orderAddPay">
        	console.log('${listCount.count}');
	        		good_info += "seq=${listCount.count}" + chr31 + "ordr_numb=${orderAddPay.ordNo}_${listCount.count}" + chr31 + "good_name=${orderAddPay.addPayRsn}" + chr31 + "good_cntx=1" + chr31 + "good_amtx=${orderAddPay.addPayAmt }" + chr30;
        	</c:forEach>
...
<form name="order_info" method="post" action="orderPayAddWeb" >
...
%>
					...
					상품명 : <input type="text" name="good_name" value="${order.orderAddPay[0].addPayRsn }"/><br/>
					결제금액 : <input type="text" name="good_mny" value="${order.orderAddPay[0].addPayAmt }" maxlength="9"/><br/>
...
<%
    ...
    /* ============================================================================== */
%>
	<input type="hidden" name="vcnt_expire_term" value="2"/>
