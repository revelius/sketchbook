<%--
 * =============================================================================
 * 파일명 : /storeInfoTi.jsp(CARHARTT WIP 타임스퀘어)
 * 작성자 : 이현우
 * 작성일자 : 2015-08-17
 *
 * 파일 내용 : storeInfo
										...
										<div id="mySwipe" class="store_info_slide_container ui_swipe">
											...
											<!-- [Start] 스토어 이미지 슬라이드 등록부분 -->
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_TIMESQUARE_01.jpg" alt="서울 타임스퀘어">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_TIMESQUARE_02.jpg" alt="서울 타임스퀘어">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_TIMESQUARE_03.jpg" alt="서울 타임스퀘어">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_TIMESQUARE_04.jpg" alt="서울 타임스퀘어">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_TIMESQUARE_05.jpg" alt="서울 타임스퀘어">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_TIMESQUARE_06.jpg" alt="서울 타임스퀘어">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_TIMESQUARE_07.jpg" alt="서울 타임스퀘어">
												</div>
...
<!-- 										</div> -->
									...
									<div class="store_info_map_wrap">
										<!-- NHN 맵 영역 -->
										<div id="naverMap" title="서울 타임스퀘어점" >
										<input type="hidden" id="lat" value="37.5172409" />
										<input type="hidden" id="lng" value="126.9037323" />
										</div>
									</div>

									<dl class="store_info_txt">
										<dt>CARHARTT WIP STORE SEOUL TIMES SQUARE</dt>
										<dd>서울특별시 영등포구 영중로 15 타임스퀘어 3층</dd>
										<dd>02.2638.2701</dd>
