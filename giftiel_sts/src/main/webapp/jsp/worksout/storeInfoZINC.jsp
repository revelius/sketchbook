							...
							<div class="content_area">
								<div class="store_info_aera">
										...
										<div id="mySwipe" class="store_info_slide_container ui_swipe">
											...
											<!-- [Start] 스토어 이미지 슬라이드 등록부분 -->
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CORNERDELI_01.JPG" alt="징크/코너델리">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CORNERDELI_02.JPG" alt="징크/코너델리">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CORNERDELI_03.JPG" alt="징크/코너델리">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CORNERDELI_04.JPG" alt="징크/코너델리">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CORNERDELI_05.JPG" alt="징크/코너델리">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CORNERDELI_06.JPG" alt="징크/코너델리">
												</div>
									...
									<dl class="store_info_txt">
										<dt>ZINC / CORNER DELI</dt>
										<dd>서울특별시 강남구 압구정로54길 21 신우빌딩 B1층</dd>
										<dd>02.541.0854</dd>
										<dd>MON - SAT, 1:00 - 8:00PM</dd>
