<%--
 * =============================================================================
 * 파일명 : /storeInfoCaWa.jsp(CARHARTT WIP 와우산)
 * 작성자 : 이현우
 * 작성일자 : 2015-08-17
 *
 * 파일 내용 : storeInfo
										...
										<div id="mySwipe" class="store_info_slide_container ui_swipe">
											...
											<!-- [Start] 스토어 이미지 슬라이드 등록부분 -->
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_HONGDAE_00.jpg" alt="서울 홍대와우산">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_HONGDAE_01.jpg" alt="서울 홍대와우산">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_HONGDAE_02.jpg" alt="서울 홍대와우산">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_HONGDAE_03.jpg" alt="서울 홍대와우산">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_HONGDAE_04.jpg" alt="서울 홍대와우산">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_HONGDAE_05.jpg" alt="서울 홍대와우산">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_HONGDAE_06.jpg" alt="서울 홍대와우산">
												</div>
...
<!-- 										</div> -->
									...
									<dl class="store_info_txt">
										<dt>CARHARTT WIP STORE SEOUL HONGDAE WOWSAN</dt>
