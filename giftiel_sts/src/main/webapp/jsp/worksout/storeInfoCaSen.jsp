<%--
 * =============================================================================
 * 파일명 : /storeInfoCaSen.jsp(WORKSOUT 부산센텀시티)
 * 작성자 : 이현우
 * 작성일자 : 2016-03-15
 *
 * 파일 내용 : storeInfo
										...
										<div id="mySwipe" class="store_info_slide_container ui_swipe">
											...
											<!-- [Start] 스토어 이미지 슬라이드 등록부분 -->
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_CENTUMCITY_01.jpg" alt="부산 신세계백화점 센텀시티">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_CENTUMCITY_02.jpg" alt="부산 신세계백화점 센텀시티">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_CENTUMCITY_03.jpg" alt="부산 신세계백화점 센텀시티">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_CENTUMCITY_04.jpg" alt="부산 신세계백화점 센텀시티">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_CENTUMCITY_05.jpg" alt="부산 신세계백화점 센텀시티">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_CENTUMCITY_06.jpg" alt="부산 신세계백화점 센텀시티">
												</div>
...
<!-- 										</div> -->
									...
									<dl class="store_info_txt">
										<dt>CARHARTT WIP STORE BUSAN CENTUM CITY MALL</dt>
										<dd>부산광역시 해운대구 센텀4로 15 신세계 센텀시티몰 2층</dd>
										<dd>051.745.2961</dd>
