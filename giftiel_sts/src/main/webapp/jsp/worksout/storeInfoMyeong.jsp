<%--
 * =============================================================================
 * 파일명 : /storeInfoMyeong.jsp(CARHARTT WIP 명동)
 * 작성자 : 이현우
 * 작성일자 : 2015-08-17
 *
 * 파일 내용 : storeInfo
										...
										<div id="mySwipe" class="store_info_slide_container ui_swipe">
											...
											<!-- [Start] 스토어 이미지 슬라이드 등록부분 -->
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_MYEONGDONG_01.jpg" alt="서울 롯데백화점 명동">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_MYEONGDONG_02.jpg" alt="서울 롯데백화점 명동">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_MYEONGDONG_03.jpg" alt="서울 롯데백화점 명동">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_MYEONGDONG_04.jpg" alt="서울 롯데백화점 명동">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_MYEONGDONG_05.jpg" alt="서울 롯데백화점 명동">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_MYEONGDONG_06.jpg" alt="서울 롯데백화점 명동">
												</div>
...
<!-- 										</div> -->
									...
									<div class="store_info_map_wrap">
										<!-- NHN 맵 영역 -->
										<div id="naverMap" title="서울 명동점" >
										<input type="hidden" id="lat" value="37.5635120" />
										<input type="hidden" id="lng" value="126.9815288" />
										</div>
									</div>

									<dl class="store_info_txt">
										<dt>CARHARTT WIP STORE SEOUL MYEONGDONG</dt>
										<dd>서울특별시 중구 남대문로 67 롯데영플라자 2층</dd>
										<dd>02.2118.5225</dd>
										<dd>AM 11:30 – PM 21:30</dd>
