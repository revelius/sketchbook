<%--
 * =============================================================================
 * 파일명 : /storeInfoCaAb.jsp(CARHARTT WIP 압구정)
 * 작성자 : 이현우
 * 작성일자 : 2015-08-17
 *
 * 파일 내용 : storeInfo
										...
										<div id="mySwipe" class="store_info_slide_container ui_swipe">
											...
											<!-- [Start] 스토어 이미지 슬라이드 등록부분 -->
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_APGUJEONG_01.jpg" alt="서울 압구정">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_APGUJEONG_02.jpg" alt="서울 압구정">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_APGUJEONG_03.jpg" alt="서울 압구정">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_APGUJEONG_04.jpg" alt="서울 압구정">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_APGUJEONG_05.jpg" alt="서울 압구정">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_APGUJEONG_06.jpg" alt="서울 압구정">
												</div>
...
<!-- 										</div> -->
									...
									<div class="store_info_map_wrap">
										...
										<input type="hidden" id="lat" value="37.5263939" />
										<input type="hidden" id="lng" value="127.0394232" />
										</div>
									</div>

									<dl class="store_info_txt">
										<dt>CARHARTT WIP STORE SEOUL APGUJEONG</dt>
										<dd>서울특별시 강남구 압구정로54길 21 신우빌딩 1층</dd>
										<dd>02.541.0870</dd>
