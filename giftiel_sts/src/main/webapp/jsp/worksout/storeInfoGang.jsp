<%--
 * =============================================================================
 * 파일명 : /storeInfoMok.jsp(CARHARTT WIP 목동)
 * 작성자 : 이현우
 * 작성일자 : 2015-08-17
 *
 * 파일 내용 : storeInfo
										...
										<div id="mySwipe" class="store_info_slide_container ui_swipe">
											...
											<!-- [Start] 스토어 이미지 슬라이드 등록부분 -->
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_GANGNAM_01.jpg" alt="서울 신세계백화점 강남">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_GANGNAM_02.jpg" alt="서울 신세계백화점 강남">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_GANGNAM_03.jpg" alt="서울 신세계백화점 강남">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_GANGNAM_04.jpg" alt="서울 신세계백화점 강남">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_GANGNAM_05.jpg" alt="서울 신세계백화점 강남">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_GANGNAM_06.jpg" alt="서울 신세계백화점 강남">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_GANGNAM_07.jpg" alt="서울 신세계백화점 강남">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/CA_GANGNAM_08.jpg" alt="서울 신세계백화점 강남">
												</div>
...
<!-- 										</div> -->
									...
									<div class="store_info_map_wrap">
										<!-- NHN 맵 영역 -->
										<div id="naverMap" title="서울 강남점" >
										<input type="hidden" id="lat" value="37.5052052" />
										<input type="hidden" id="lng" value="127.0041100" />
										</div>
									</div>

									<dl class="store_info_txt">
										<dt>CARHARTT WIP STORE SEOUL GANGNAM</dt>
										<dd>서울특별시 서초구 신반포로 176 지하1층</dd>
										<dd>02.3479.1246</dd>
