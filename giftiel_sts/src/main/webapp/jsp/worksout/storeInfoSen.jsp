<%--
 * =============================================================================
 * 파일명 : /storeInfoSen.jsp(CARHARTT WIP 부산센텀시티)
 * 작성자 : 이현우
 * 작성일자 : 2015-08-17
 *
 * 파일 내용 : storeInfo
										...
										<div id="mySwipe" class="store_info_slide_container ui_swipe">
											...
											<!-- [Start] 스토어 이미지 슬라이드 등록부분 -->
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/W_CENTUMCITY_01.jpg" alt="부산 신세계백화점 센텀시티">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/W_CENTUMCITY_02.jpg" alt="부산 신세계백화점 센텀시티">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/W_CENTUMCITY_03.jpg" alt="부산 신세계백화점 센텀시티">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/W_CENTUMCITY_04.jpg" alt="부산 신세계백화점 센텀시티">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/W_CENTUMCITY_05.jpg" alt="부산 신세계백화점 센텀시티">
												</div>
												<div class="store_info_item">
													<img src="/resources/worksout/images/storeinfo/W_CENTUMCITY_06.jpg" alt="부산 신세계백화점 센텀시티">
												</div>
...
<!-- 										</div> -->
									...
									<div class="store_info_map_wrap">
										<!-- NHN 맵 영역 -->
										<div id="naverMap" title="부산 센텀시티몰점" >
										<input type="hidden" id="lat" value="35.1698615" />
										<input type="hidden" id="lng" value="129.1282901" />
										</div>
									</div>

									<dl class="store_info_txt">
										<dt>WORKSOUT STORE BUSAN CENTUM CITY MALL</dt>
										<dd>부산광역시 해운대구 센텀4로 15 신세계 센텀 시티몰 2층</dd>
										<dd>051.745.1531</dd>
<!-- 										<dd>AM 10:30 – PM 20:00 평일 / AM 10:30 – PM 21:00 금, 토, 일, 공휴일</dd> -->
										<dd>AM 10:30 – PM 22:00</dd>
