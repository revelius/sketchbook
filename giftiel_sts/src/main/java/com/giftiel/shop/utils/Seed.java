...
public class Seed {
	 ...
	 * @return byte[] 암호화 된 데이터
	 */
	private byte[] encrypt(String inData, byte szKey[]) {
	 ...
	 * @return byte[] 암호화 된 데이터
	 */
	private byte[] encrypt(String inData, byte szKey[], String charset)
	 ...
	 * @return byte[] 복호화 된 바이트 데이터
	 */
	private String decryptAsString(byte[] encryptBytes, byte[] szKey) {
	...
	/**
	 * String parameter로만 암호화해서 반환한다.
	 * @param str
	 * @return
	 * @throws UnsupportedEncodingException
	 */
	public String encrypt(String str) throws UnsupportedEncodingException {
		byte[] encryptText = Base64.encodeBase64(encrypt(str, key.getBytes(), "UTF-8"));
		String result = openFileToString(encryptText);
		return result;
	}	

	/**
	 * String parameter로만 복호화해서 반환한다.
	 * @param str
	 * @return
	 * @throws UnsupportedEncodingException
	 */	
	public String decrypt(String str) throws UnsupportedEncodingException {
		String result = decryptAsString(Base64.decodeBase64(str.getBytes()), key.getBytes(),"UTF-8");
		return result;
	}
