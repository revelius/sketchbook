...
public class GoodsSize {
	...
	private String sizeNm;         //사이즈 이름 
	private String size1;         //사이즈_1 
	private String size2;         //사이즈_2 
	private String size3;         //사이즈_3 
	private String size4;         //사이즈_4 
	private String size5;         //사이즈_5 
	private String size6;         //사이즈_6 
	private String size7;         //사이즈_7 
	private String size8;         //사이즈_8 
	private String size9;         //사이즈_9 
	private String size10;         //사이즈_10 
	private Integer prir;         //정렬순서
