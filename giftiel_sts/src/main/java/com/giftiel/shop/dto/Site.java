...
public class Site {
	...
	public String getFabiconNm() {
		return fabiconNm;
	}
	public void setFabiconNm(String fabiconNm) {
		this.fabiconNm = fabiconNm;
	}
	public String getFabiconImg() {
		return fabiconImg;
	}
	public void setFabiconImg(String fabiconImg) {
		this.fabiconImg = fabiconImg;
	}
	...
	public String getSiteDesc2() {
		return siteDesc2;
	}
	public void setSiteDesc2(String siteDesc2) {
		this.siteDesc2 = siteDesc2;
	}
