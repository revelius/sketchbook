...
public class User {
	...
	private String[] tempSiteAuthNo;         //권한그룹번호 임시저장용
	
	
	
	
	public String[] getTempSiteAuthNo() {
		return tempSiteAuthNo;
	}
	public void setTempSiteAuthNo(String[] tempSiteAuthNo) {
		this.tempSiteAuthNo = tempSiteAuthNo;
	}
	public String getSiteAuthNo() {
		return siteAuthNo;
	}
	public void setSiteAuthNo(String siteAuthNo) {
		this.siteAuthNo = siteAuthNo;
	}
	public int getIdx() {
		return idx;
	}
